    ...
    <div className="bg-black">
      ...
      <div className=" flex mt-20 max-h-screen text-white w-full">
        <div className="border-r-2 w-1/2">
          <div className="text-white mt-20 mb-48">
            <h2 className="text-2xl text-center">Simulating for sensor code &quot;rn285&quot;</h2>
        ...
        <div className=" w-1/2 text-center mt-32">
          <div className="text-white text-2xl font-semibold text-left ml-16 font-Roboto">
            ...
            <h2 className="my-2">SLR Points DashBoard</h2>
            <p className="my-2">
              You will receive{" "}
              <span className="text-emerald">{slrTokens.toFixed()}</span> SLR Points
            </p>
            {hasStopped &&
